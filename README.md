...
```
# Output:
<img width="442" height="146" alt="image" src="https://github.com/user-attachments/assets/699e525f-6492-4667-ae0b-76e164cde0c4" />
...
```
# Output:
<img width="460" height="161" alt="image" src="https://github.com/user-attachments/assets/c4af78fa-5bf1-484b-b266-c84000536f40" />
...
# Output:
<img width="438" height="329" alt="image" src="https://github.com/user-attachments/assets/0e8968c0-eabb-4ff8-a628-73e7ee951cbb" />
...
int main() {
    ...
    printf("%d %d %d", d.cal_year, d.cal_month, d.cal_date);

    return 0;
}
```
# Output:
<img width="443" height="168" alt="image" src="https://github.com/user-attachments/assets/85df9592-eecd-4663-9be1-acf6f7e638b6" />
...
```
# Output:
<img width="458" height="155" alt="image" src="https://github.com/user-attachments/assets/12dd5d76-34b2-4cf9-99e1-59c830460c65" />
